...
class sales_repor(models.Model):
    ...
    def _query(self, with_clause='', fields={}, groupby='', from_clause=''):
        ...
        select_ = """
            ...
            s.customer_order_delivery_date as customer_order_delivery_date,
            s.state as state,
            ...
            extract(epoch from avg(date_trunc('day',s.customer_order_delivery_date)-date_trunc('day',s.create_date)))/(24*60*60)::decimal(16,2) as Deliverydelay,
        ...
        groupby_ = """
            ...
            s.name,
            s.date_order,
            s.customer_order_delivery_date,
            s.partner_id,
            s.user_id,
            s.state,
            s.company_id,
